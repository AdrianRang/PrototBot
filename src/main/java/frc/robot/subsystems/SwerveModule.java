...
public class SwerveModule extends SubsystemBase {
    ...
    public SwerveModule(SwerveModuleOptions options) {
        ...
        this.turnConfig.encoder
            .positionConversionFactor(Constants.SwerveChassisConstants.PhysicalModel.kTurningEncoder_Rotation)
            .velocityConversionFactor(Constants.SwerveChassisConstants.PhysicalModel.kTurningEncoder_RPS);
        ...
        this.turnConfig.closedLoop
            .p(Constants.SwerveModuleConstants.kTurningPIDConstants.kP)
            .i(Constants.SwerveModuleConstants.kTurningPIDConstants.kI)
            .d(Constants.SwerveModuleConstants.kTurningPIDConstants.kD)
    ...
    public AngularVelocity getAngularVelocity() {
        return RPM.of(this.driveMotor.getEncoder().getVelocity());
    }

    public LinearVelocity getVelocity() {
        return MetersPerSecond.of(getAngularVelocity().in(RPM) * Constants.SwerveChassisConstants.PhysicalModel.kDriveEncoder_RPMToMeterPerSecond);
    }

    public Distance getDrivePosition() {
        return Meters.of(this.driveMotor.getEncoder().getPosition() * Constants.SwerveChassisConstants.PhysicalModel.kDriveEncoder_RotationToMeter);
    }
    ...
    public void setTargetState(SwerveModuleState state, boolean force) {
        ...
        // Set motor speeds
        driveMotor.setVoltage(state.speedMetersPerSecond / Constants.SwerveChassisConstants.PhysicalModel.kMaxSpeed.in(MetersPerSecond) * 12);
